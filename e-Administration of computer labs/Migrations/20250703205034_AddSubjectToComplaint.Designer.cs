...
namespace e_Administration_of_computer_labs.Migrations
{
    ...
    [Migration("20250703205034_AddSubjectToComplaint")]
    partial class AddSubjectToComplaint
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("e_Administration_of_computer_labs.Models.LabReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("e_Administration_of_computer_labs.Models.Complaint", b =>
                {
                    ...
                    b.HasOne("e_Administration_of_computer_labs.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("e_Administration_of_computer_labs.Models.LabAssignment", b =>
                {
                    b.HasOne("e_Administration_of_computer_labs.Models.ApplicationUser", "Instructor")
                        .WithMany()
